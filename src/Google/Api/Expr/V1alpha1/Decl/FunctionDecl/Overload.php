...
class Overload extends \Google\Protobuf\Internal\Message
{
     ...
     * `name`.
     *
     * Generated from protobuf field <code>string overload_id = 1 [json_name = "overloadId"];</code>
     */
    protected $overload_id = '';
    /**
     ...
     *
     * Generated from protobuf field <code>.google.api.expr.v1alpha1.Type result_type = 4 [json_name = "resultType"];</code>
     */
     ...
     *
     * Generated from protobuf field <code>bool is_instance_function = 5 [json_name = "isInstanceFunction"];</code>
     */
    protected $is_instance_function = false;
    /**
     * Documentation string for the overload.
     *
     * Generated from protobuf field <code>string doc = 6 [json_name = "doc"];</code>
     */
    protected $doc = '';
