...
class CheckedExpr extends \Google\Protobuf\Internal\Message
{
     ...
     *   the message.
     *
     * Generated from protobuf field <code>map<int64, .google.api.expr.v1alpha1.Reference> reference_map = 2 [json_name = "referenceMap"];</code>
     */
     ...
     * space.
     *
     * Generated from protobuf field <code>map<int64, .google.api.expr.v1alpha1.Type> type_map = 3 [json_name = "typeMap"];</code>
     */
    private $type_map;
    /**
     ...
     *
     * Generated from protobuf field <code>.google.api.expr.v1alpha1.SourceInfo source_info = 5 [json_name = "sourceInfo"];</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.api.expr.v1alpha1.Expr expr = 4 [json_name = "expr"];</code>
     */
    protected $expr = null;
     ...
     * @return $this
     */
    public function setExprVersion($var)
    {
