...
class HttpRule extends \Google\Protobuf\Internal\Message
{
     ...
     * message type.
     *
     * Generated from protobuf field <code>string body = 7 [json_name = "body"];</code>
     */
    protected $body = '';
    /**
     ...
     * message type.
     *
     * Generated from protobuf field <code>string response_body = 12 [json_name = "responseBody"];</code>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.api.HttpRule additional_bindings = 11 [json_name = "additionalBindings"];</code>
     */
     ...
     * resources.
     *
     * Generated from protobuf field <code>string get = 2 [json_name = "get"];</code>
     * @return string
     */
     ...
     * Maps to HTTP PUT. Used for replacing a resource.
     *
     * Generated from protobuf field <code>string put = 3 [json_name = "put"];</code>
     * @return string
     */
     ...
     * Maps to HTTP POST. Used for creating a resource or performing an action.
     *
     * Generated from protobuf field <code>string post = 4 [json_name = "post"];</code>
     * @return string
     */
     ...
     * Maps to HTTP DELETE. Used for deleting a resource.
     *
     * Generated from protobuf field <code>string delete = 5 [json_name = "delete"];</code>
     * @return string
     */
     ...
     * Maps to HTTP PATCH. Used for updating a resource.
     *
     * Generated from protobuf field <code>string patch = 6 [json_name = "patch"];</code>
     * @return string
     */
     ...
     * for services that provide content to Web (HTML) clients.
     *
     * Generated from protobuf field <code>.google.api.CustomHttpPattern custom = 8 [json_name = "custom"];</code>
