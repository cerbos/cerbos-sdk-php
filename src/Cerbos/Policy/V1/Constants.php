 ...
 */
class Constants extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    private $import;
    /**
     * Generated from protobuf field <code>map<string, .google.protobuf.Value> local = 2 [json_name = "local"];</code>
     */
    private $local;
