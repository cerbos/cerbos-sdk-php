 ...
 *
 * Generated from protobuf message <code>cerbos.response.v1.CheckResourceBatchResponse</code>
 */
class CheckResourceBatchResponse extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Cerbos\Response\V1\CheckResourceBatchResponse\ActionEffectMap::class);
        $this->results = $arr;
