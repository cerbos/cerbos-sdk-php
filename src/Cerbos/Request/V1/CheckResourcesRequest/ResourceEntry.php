...
namespace Cerbos\Request\V1\CheckResourcesRequest;
...
/**
 * Generated from protobuf message <code>cerbos.request.v1.CheckResourcesRequest.ResourceEntry</code>
 */
class ResourceEntry extends \Google\Protobuf\Internal\Message
{
    /**
...
class_alias(ResourceEntry::class, \Cerbos\Request\V1\CheckResourcesRequest_ResourceEntry::class);
