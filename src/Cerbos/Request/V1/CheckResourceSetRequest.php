 ...
 *
 * Generated from protobuf message <code>cerbos.request.v1.CheckResourceSetRequest</code>
 */
class CheckResourceSetRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * Generated from protobuf field <code>.cerbos.request.v1.ResourceSet resource = 4 [json_name = "resource", (.google.api.field_behavior) = REQUIRED];</code>
     */
    protected $resource = null;
    /**
     * Generated from protobuf field <code>bool include_meta = 5 [json_name = "includeMeta", (.grpc.gateway.protoc_gen_openapiv2.options.openapiv2_field) = {</code>
     */
    protected $include_meta = false;
    /**
     * Generated from protobuf field <code>.cerbos.request.v1.AuxData aux_data = 6 [json_name = "auxData", (.google.api.field_behavior) = OPTIONAL];</code>
     */
    ...
    {
        GPBUtil::checkMessage($var, \Cerbos\Request\V1\ResourceSet::class);
        $this->resource = $var;
