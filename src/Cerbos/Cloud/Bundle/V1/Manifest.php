...
/**
 * Generated from protobuf message <code>cerbos.cloud.bundle.v1.Manifest</code>
 */
class Manifest extends \Google\Protobuf\Internal\Message
{
    ...
    private $schemas;
    /**
     * Generated from protobuf field <code>.cerbos.cloud.bundle.v1.Meta meta = 4 [json_name = "meta"];</code>
     */
    protected $meta = null;
     ...
     *     @type string[] $schemas
     *     @type \Cerbos\Cloud\Bundle\V1\Meta $meta
     * }
     */
    ...
    /**
     * Generated from protobuf field <code>.cerbos.cloud.bundle.v1.Meta meta = 4 [json_name = "meta"];</code>
     * @return \Cerbos\Cloud\Bundle\V1\Meta|null
     */
    ...
    /**
     * Generated from protobuf field <code>.cerbos.cloud.bundle.v1.Meta meta = 4 [json_name = "meta"];</code>
     * @param \Cerbos\Cloud\Bundle\V1\Meta $var
     * @return $this
     */
    public function setMeta($var)
    {
        GPBUtil::checkMessage($var, \Cerbos\Cloud\Bundle\V1\Meta::class);
        $this->meta = $var;
