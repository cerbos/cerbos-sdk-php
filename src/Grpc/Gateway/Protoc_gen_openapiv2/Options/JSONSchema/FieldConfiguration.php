...
class FieldConfiguration extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>string path_param_name = 47 [json_name = "pathParamName"];</code>
     */
...
class_alias(FieldConfiguration::class, \Grpc\Gateway\Protoc_gen_openapiv2\Options\JSONSchema_FieldConfiguration::class);
